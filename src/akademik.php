...
<body class="bg-[#DFEBFB] h-screen flex ">
  <header class="bg-[#5651AB] w-[344px] rounded-r-3xl flex justify-center items-start ">
      <nav class="">
          <ul class="text-[#A4B3C7] text-2xl">
            <li class="m-10 mt-16 flex gap-3 active:text-white hover:text-white">
            ...
            <li class="m-10 flex gap-3 active:text-white text-white">
            ...
            <li class="m-10 flex gap-3 active:text-white hover:text-white">
